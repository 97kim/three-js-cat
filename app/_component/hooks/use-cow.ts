...
const useCow = () => {
  useEffect(() => {
    ...
    scene.background = new THREE.Color(0x634799);
    ...
    mtlLoader.load('/model/cow.mtl', (materials: MTLLoader.MaterialCreator) => {
      materials.preload();
      ...
      objLoader.load(
        ...
        (object: THREE.Object3D) => {
          ...
          const animate = () => {
            ...
            object.rotation.z += 0.04; // Rotate the object around the Y-axis
